...
var fs = require("fs");
var catalogojson = fs.readFileSync("./database/catalogo.json","utf8")
console.log(catalogojson)
var catalogo = JSON.parse(catalogojson)
...
function alterarStatusEmCartaz (codigoIdent){
  ...
  trocaStatus.emCartaz = !trocaStatus.emCartaz
  console.log(trocaStatus)
}
alterarStatusEmCartaz(2);

fs.writeFileSync("./database/catalogo.json",JSON.stringify(catalogo))